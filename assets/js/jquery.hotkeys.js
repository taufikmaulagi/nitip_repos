...
$.each(elements, function(i, e) {
    ...
    $(document).bind('keydown', elements[i], function assets() {
      if($('li.menu-bar').length > 0 && $('li.menu-bar [data-shortcut="'+newElement+'"]').length == 1) {
    		window.location = $('li.menu-bar [data-shortcut="'+newElement+'"]').attr('href');
      } else if ($('.sidebar-panel [data-shortcut="'+newElement+'"]').length == 1) {
        window.location = $('.sidebar-panel [data-shortcut="'+newElement+'"]').attr('href');
      }
      return false;
    });
 });