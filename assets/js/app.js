...
$(function(){
	...
	if($('.filter-panel').length > 0) {
		$('.content-header .float-right').append('<button class="btn btn-fresh btn-sm btn-icon-only btn-filter-panel-show px-3" type="button" title="'+lang.filter+'"><i class="fa-search mr-1"></i> '+lang.filter+'</button>');
