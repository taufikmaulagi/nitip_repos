				...
				<form id="form-command" action="<?php echo base_url('account/dokumen/save'); ?>" data-callback="reload" method="post" data-submit="ajax">
						...
						<div class="col-sm-4">
							...
							<div class="input-group">
								...
								<div class="input-group-append">
									...
									<a href="<?php echo base_url('assets/uploads/rekanan/'.user('id_vendor').'/'.$file[$d->id]); ?>" target="_blank" class="btn btn-sky" title="<?php echo lang('unduh'); ?>"><i class="fa-download"></i></a>

									<?php } ?>

									<button class="btn btn-fresh btn-file" type="button"><?php echo lang('unggah'); ?></button>
					...
					<div class="form-group row">
						...
						<div class="col-sm-7 offset-sm-5">
							...
							<button type="submit" class="btn btn-sky"><?php echo lang('simpan'); ?></button>
