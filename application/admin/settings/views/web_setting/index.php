		...
		<form id="form-command" action="<?php echo base_url('settings/web_setting/save'); ?>" data-callback="reload" method="post" data-submit="ajax" class="tab-app">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
					<div class="row">
						<div class="col-sm-6">
							...
							<hr/>
							<div class="form-group row">
								<label class="col-sm-3 col-form-label"><?php echo "Max Call Activity" ?></label>
								<div class="col-sm-9">
									<input type="number" class="form-control" name="max_dfr" value="<?=setting('max_dfr')?>">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-3 col-form-label"><?php echo "Max DFR" ?></label>
								<div class="col-sm-9">
									<input type="number" class="form-control" name="max_dfr_a" value="<?=setting('max_dfr_a')?>">
								</div>
							</div>
						</div>
						<div class="col-sm-6">
				...
				<div class="tab-pane fade" id="email" role="tabpanel" aria-labelledby="email-tab">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<button type="button" class="btn btn-fresh btn-input" data-id="0" aria-label="<?php echo lang('kirim_email'); ?>"><i class="fa-envelope"></i><?php echo lang('kirim_email'); ?></button>
						</div>
					</div>
				</div>
				<div class="tab-pane fade" id="template" role="tabpanel" aria-labelledby="template-tab">
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group row">
								<label class="col-sm-3 col-form-label" for="font"><?php echo 'Font Default' ?></label>
								<div class="col-sm-9">
									<select class="select2 infinity form-control" name="font">
										<option value="Roboto" <?=setting('font') == 'Roboto' ? 'selected="selected"' : ''?>> Roboto <b> [ Recomended ] </b> </option>
										<option value="Poppins" <?=setting('font') == 'Poppins' ? 'selected="selected"' : ''?>> Poppins <b> [ Recomended ] </b> </option>
										<option value="GoogleSans" <?=setting('font') == 'GoogleSans' ? 'selected="selected"' : ''?>> GoogleSans </option>
										<option value="OpenSans" <?=setting('font') == 'OpenSans' ? 'selected="selected"' : ''?>> OpenSans </option>
										<option value="Ubuntu" <?=setting('font') == 'Ubuntu' ? 'selected="selected"' : ''?>> Ubuntu </option>
									</select>
								</div>
							</div>
							<div class="form-group row">
				...
				<div class="tab-footer">
					<div class="row">
						<div class="col-12">
							<button type="submit" class="btn btn-sky"><?php echo lang('simpan_perubahan'); ?></button>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo base_url('settings/web_setting/check_email'); ?>" id="form">
					...
					<div class="form-group row">
						<div class="col-sm-12">
							<button type="submit" class="btn btn-sky"><?php echo lang('kirim_email'); ?></button>
							<button type="reset" class="btn btn-fresh"><?php echo lang('batal'); ?></button>
						</div>
					</div>
				</form>
			</div>
