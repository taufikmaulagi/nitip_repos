<div class="content-header">
	<div class="main-container position-relative">
		...
		<div class="float-right">
			...
			<button type="button" class="btn btn-sky btn-sm btn-icon-only cInfo" data-target="<?php echo base_url('settings/auto_code/help'); ?>" aria-label="<?php echo lang('bantuan'); ?>"><i class="fa-question-circle"></i></button>
		</div>
