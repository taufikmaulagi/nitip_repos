<div class="content-header">
	<div class="main-container position-relative">
		...
		<div class="float-right">
			<button type="button" class="btn btn-sky btn-sm btn-add-lang"><i class="fa-plus"></i><?php echo lang('tambah'); ?></button>
		</div>
		<?php } ?>
...
<?php
	table_open('',true);
		...
		tbody();
			foreach($bahasa as $b) {
				$button = '';
				if($menu_access['access_edit']) $button .= '<a href="'.base_url('settings/bahasa/d/'.$b).'" title="'.lang('detil').'" class="btn btn-sky"><i class="fa-search"></i></a> ';
				if($menu_access['access_delete']) $button .= '<button type="button" class="btn btn-hot btn-delete-lang" data-key="delete" data-id="'.$b.'" title="'.lang('hapus').'"><i class="fa-trash-alt"></i></button>';
				tr();
					td(strtoupper($b));
