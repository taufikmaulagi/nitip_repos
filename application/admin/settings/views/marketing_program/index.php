...
<div class="content-body">
	<?php
	table_open('',true,base_url('settings/marketing_program/data'),'marketing_program');
		thead();
			tr();
...
modal_open('modal-form');
	modal_body();
		form_open(base_url('settings/marketing_program/save'),'post','form');
			col_init(3,9);
			input('hidden','id','id');
...
modal_open('modal-import',lang('impor'));
	modal_body();
		form_open(base_url('settings/marketing_program/import'),'post','form-import');
			col_init(3,9);
...
<script>
	function filter(){
		...
		$('[data-serverside]').attr('data-serverside', base_url+'settings/marketing_program/data?pgroup='+pgroup);
		refreshData();
	}
</script>
