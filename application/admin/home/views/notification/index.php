<div class="content-header">
	<div class="main-container position-relative">
		...
		<div class="float-right">
			<button type="button" class="btn btn-sky btn-sm btn-view"><i class="fa-check-circle"></i>Tandai Sudah Dilihat</button>
		</div>
...
<div class="content-body body-light">
	<div class="main-container">
		...
		<form class="text-center" id="load-more" action="<?php echo base_url('home/notification/load_data'); ?>">
			<button class="btn btn-sm btn-sky" id="btn-more" type="submit">
				Muat Lainnya
			</button>
		</form>
	</div>
