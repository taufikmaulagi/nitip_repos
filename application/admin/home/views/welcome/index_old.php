<div class="content-body body-home">
	<div class="body-bg color-bg" style="background-image: url('<?=base_url('assets/images/cover-default-2.png')?>');  background-position: center; background-repeat: no-repeat; background-size: cover;">
