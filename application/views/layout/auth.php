...
<body class="body-bg body-login<?php echo ' '.setting('warna_dropdown'); ?>"  style="background-image: url('<?=base_url('assets/images/bg.jpg')?>');  background-position: center; background-repeat: no-repeat; background-size: cover;">
	<?php flash_message();  ?>
	<div class="container">
