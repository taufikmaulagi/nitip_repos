<div class="content-header">
	<div class="main-container position-relative">
		...
		<div class="float-right">
			<button type="button" class="btn btn-sky btn-sm cInfo" data-target="<?php echo base_url('command/help'); ?>"><i class="fa-question-circle"></i>Bantuan</button>
		</div>
...
<div class="content-body">
	<div class="main-container">
		...
		<form id="form-command" action="<?php echo base_url('command/process'); ?>" method="post" data-submit="ajax">
			...
			<div class="form-group row">
				<div class="col-12">
					<button type="submit" class="btn btn-sky">Proses</button>
				</div>
			</div>
		</form>
	</div>
