	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			...
			<div class="text-center">
				<a href="javascript:;" onclick="history.back()" class="btn btn-fresh"><i class="fa-chevron-left"></i> &nbsp; Kembali</a>
				<a href="<?php echo base_url('pengumuman/download/'.encode_id([$id,rand()])); ?>" target="_blank" class="btn btn-fresh"><i class="fa-download"></i> &nbsp; Unduh</a>
			</div>
		</div>
	</div>
</div>